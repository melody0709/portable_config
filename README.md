...
基于 [mpv](https://mpv.io/) + [uosc](https://github.com/tomasklaen/uosc) 5.12 的 IPTV 播放器，支持 M3U 分组、EPG 节目单和回看功能。
...
```ini
# IPTV 快捷键
F8 script-binding iptv/show-menu      # 打开频道菜单
F9 script-binding iptv/show-epg       # 打开节目单
```
