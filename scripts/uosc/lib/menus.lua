---@alias OpenCommandMenuOptions {submenu?: string; mouse_nav?: boolean; on_close?: string | string[]; anchor_x?: 'left'|'center'|'right'; anchor_offset?: number;}
---@param data MenuData
...
function open_command_menu(data, opts)
	...
	---@type MenuOptions
	local menu_opts = table_assign_props({}, opts, {'mouse_nav', 'anchor_x', 'anchor_offset'})
